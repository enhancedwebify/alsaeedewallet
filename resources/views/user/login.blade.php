                            ...
                            <form action="{{route('user.login')}}" method="post">
                                ...
                                <div class="forminput">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input dir="ltr" autocomplete required name="id_number" type="text" class="form-control" id="floatingInput" placeholder="name@example.com">
                                        <label for="floatingInput" style="right:0;left:auto;margin:0;">الهوية الوطنية</label>
                                    </div>
